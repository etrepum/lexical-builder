...
export function mountReactExtensionComponent<Extension extends AnyLexicalExtension>(
  ...
  const { Component } = getExtensionDependencyFromEditor(editor, extension).output;
