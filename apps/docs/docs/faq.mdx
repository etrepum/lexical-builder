...
## Why is it called a Extension instead of a Plugin?
...
When you depend on a Extension that depends on `ReactExtension`, you will get a runtime
...
dependency. This way you won't get confused if you add a extension that requires
...
supported, or extensionned to be supported, because I am pretty sure that
